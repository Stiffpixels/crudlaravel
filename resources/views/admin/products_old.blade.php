        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    ...
                    <div>
                        <button type="button" id="{{$product->id}}-edit-btn" data-bs-toggle="modal"
                            data-bs-target="#{{$product->id}}-edit-modal"
                            class="user-edit-btn text-white bg-success border-0">
                            Edit
                        </button>
                        <div class="modal" id="{{$product->id}}-edit-modal" tabindex="-1">
                            <div class="modal-dialog">
                                <form class="modal-content" method="post"
                                    action="/dashboard/products/update/{{$product->id}}">
                                    @csrf
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            ...
                                            <input id="product_name" value="{{$product->name}}"
                                                class="block mt-1 w-full" type="text" name="name" required
                                                autocomplete="product_name" />
                                        </div>

                                        <div>
                                            <label for="product_slug">Slug</label>
                                            <input id="product_slug" value="{{$product->slug}}"
                                                class="block mt-1 w-full" type="text" name="slug" required
                                                autocomplete="product_slug" />
                                        </div>

                                        <div>
                                            <label for="product_desc">description</label>
                                            <input id="product_desc" value="{{$product->description}}"
                                                class="block mt-1 w-full" type="text" name="description" required
                    ...
                    <div>
                        <button type="button" id="{{$product->id}}-delete-btn" data-bs-toggle="modal"
                            data-bs-target="#{{$product->id}}-delete-modal"
                            class="user-edit-btn bg-danger text-white border-0">
                            Delete
                        </button>
